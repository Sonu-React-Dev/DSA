...
2. [JavaScript Data Structure Cheat Sheet](#2-javascript-data-structure-cheat-sheet)
...
4. [Non-Linear Data Structures](#4-non-linear-data-structures)
   - [Hash Tables (Objects & Maps)](#hash-tables-objects--maps)
   - [Trees & Binary Search Trees (BST)](#trees--binary-search-trees-bst)
...
5. [Core Algorithmic Patterns](#5-core-algorithmic-patterns)
   - [Two Pointers](#two-pointers)
   - [Sliding Window](#sliding-window)
   - [Fast & Slow Pointers (Floyd's Cycle)](#fast--slow-pointers-floyds-cycle)
   - [Binary Search](#binary-search)
   - [Sorting Algorithms](#sorting-algorithms)
6. [Advanced Algorithmic Techniques](#6-advanced-algorithmic-techniques)
   - [Recursion & Backtracking](#recursion--backtracking)
   - [Dynamic Programming (DP)](#dynamic-programming-dp)
   - [Greedy Algorithms](#greedy-algorithms)
   - [Graph Algorithms (BFS, DFS, Dijkstra)](#graph-algorithms-bfs-dfs-dijkstra)
